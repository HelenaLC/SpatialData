...
There are only `r length(shape(x, "cells"))` cells, but 
`r format(length(point(x, "single_molecule")), big.mark=",")`` molecules, 
so that we downsample a random subset of 2,000 molecules for visualization:
