...
- `rotateArray`: scalar integer (angle).
- `scaleArray`: numeric vector with as many elements as SD has dimensions.
- `translateArray`: integer vector of length 2 (row/y and col/x translation).
